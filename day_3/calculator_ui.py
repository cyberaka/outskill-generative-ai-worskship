...
api_url = "https://outskill-generative-ai-worskship.onrender.com/"
...
def calculate_result():
    try:
        ...
        payload = {"a": first_num, "b": second_num}
...
with col4:
    st.button("subtract(-)", on_click=operation_click, args=("subtract",), use_container_width=True)
